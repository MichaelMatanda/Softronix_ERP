...
public class EmailConstants {
    ...
    public static final String PASSWORD = "bnfnyprbzwxtvaha";
    public static final String FROM_EMAIL = "tafadzwamuungani18@gmail.com";
    public static final String CC_EMAIL = "";
    public static final String EMAIL_SUBJECT = "Softronix, ERP-NEW PASSWORD";
